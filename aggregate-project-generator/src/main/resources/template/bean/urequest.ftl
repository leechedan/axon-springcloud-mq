...
@Data
@ToString
@ApiModel(value = "${className}UpdateRequest", description = "${classDesc}更新请求参数")
public class ${className}UpdateRequest extends BaseRequest implements Serializable {
...
<#if classInfo.fieldList?exists && classInfo.fieldList?size gt 0>
 <#list classInfo.fieldList as fieldItem >
  <#if !fieldItem.ignore || fieldItem.isPrimaryKey>
    ...
    <#if fieldItem.isPrimaryKey>@NotNull(message = "id不能为空")</#if>
