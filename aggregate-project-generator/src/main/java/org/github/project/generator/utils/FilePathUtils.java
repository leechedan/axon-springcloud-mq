...
public class FilePathUtils {
    ...
    public static String getPackPath(String projectName) throws Exception {
        return getPackPath(projectName, "-");
    }
    /**
     * 通过 项目名称 生成包
     * projectName 项目名称
     * 如：file-uoplod ----》com/github/file/uoplod/
     */
    public static String getPackPath(String projectName, String splitChar) throws Exception {
        StringBuffer result = new StringBuffer("com/");
        String[] split = projectName.split(splitChar);
     ...
     * 通过 项目名称 生成 包名
     * projectName 项目名称
     * 如：bfp-file-upload ----》bfp.file.upload
     */
     ...
     * 通过 项目名称 生成 包名
     * projectName 项目名称
     * 如：bfp-file-upload ----》file-upload-server
     */
    ...
    public static void main(String[] args) throws Exception{
        log.info(getPackPath("bfp-file-uoplod"));
        log.info(getClassName("bfp-file-uoplod"));
        log.info(getClassNameFirst("bfp-file-uoplod"));
        log.info(getServerId("bfp-file-uoplod"));
    }
}
