...
public class ConfigGenerateUtil {
     ...
     * filePath = .......-rest
     */
    public static void generateConfig(String filePath, String projectName) throws Exception {
        //生成local.properties
        generateLocal(filePath,projectName);
        //生成dev.properties
        generateDev(filePath,projectName);
        //生成test.properties
        generateTest(filePath,projectName);
        //生成prod.properties
        generateProd(filePath,projectName);
    }
     ...
     * filePath = .......-rest
     */
    public static void generateLocal(String filePath,String projectName) throws Exception {
     ...
     * filePath = .......-rest
     */
    public static void generateDev(String filePath,String projectName) throws Exception {
        filePath = filePath+PathConstant.RESOURCEPATH+"/config";
        File srcPath = new File(filePath);
        srcPath.mkdirs();
     ...
     * filePath = .......-rest
     */
    public static void generateTest(String filePath,String projectName) throws Exception {
        filePath = filePath+PathConstant.RESOURCEPATH+"/config";
        File srcPath = new File(filePath);
        srcPath.mkdirs();
     ...
     * filePath = .......-rest
     */
    public static void generateProd(String filePath,String projectName) throws Exception {
        filePath = filePath+PathConstant.RESOURCEPATH+"/config";
        File srcPath = new File(filePath);
        srcPath.mkdirs();
