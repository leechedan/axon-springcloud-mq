...
public class UserQueryHandler {
    ...
    public UserAggregate on(QueryUserCommand command) {
        LockAwareAggregate<UserAggregate, EventSourcedAggregate<UserAggregate>> lockAwareAggregate = userAggregateRepository.load(command.getId().toString(), command.getInstant());
